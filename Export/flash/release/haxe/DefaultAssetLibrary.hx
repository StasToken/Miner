...
@:keep @:bind #if display private #end class __ASSET__assets_psd_harvester_right_psd extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_psd_harvester_down_psd extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_psd_earth_psd extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_psd_harvester_up_psd extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_psd_harvester_left_psd extends flash.utils.ByteArray { }
